...
// NewProperty ...
func NewProperty(id string) *PropertyConfig {
	return &PropertyConfig{Model: Model{
		ID: id,
	}}
}

// Properties ...
func (obj *PropertyConfig) Properties() ([]*PropertyConfig, error) {
	var properties []*PropertyConfig
